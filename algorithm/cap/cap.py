...
from common.util import rand_direction
from common.distance import squared_distance
from common.estimator import EstimatorModel, Estimator
from common.partition import Partition, max_affine_partition
from common.regression import max_affine_fit_partition, max_affine_predict
...
def cap_train(
    ...
    **kwargs
    ...
    XW = X1.dot(W)
    # eprint('XW.shape: {}'.format(XW.shape))
