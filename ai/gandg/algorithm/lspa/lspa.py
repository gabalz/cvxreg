...
from ai.gandg.common.partition import rand_voronoi_partition, max_affine_partition
from ai.gandg.common.distance import squared_distance
from ai.gandg.common.regression import max_affine_predict, max_affine_fit_partition
